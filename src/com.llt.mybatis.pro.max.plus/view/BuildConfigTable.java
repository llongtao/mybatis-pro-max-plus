...
public class BuildConfigTable  {
    ...
    public BuildConfigTable(Project project) {
        ...
        buildConfigTable.getColumnModel().getColumn(5).setCellEditor(new AbstractTableCellEditor() {
        ...
        buildConfigTable.getColumnModel().getColumn(6).setCellRenderer((table, value, isSelected, hasFocus, row, column) -> {
            JButton del = new JButton("删除");
            del.addActionListener(e -> {
                System.out.println("del"+table.getSelectedRow());
                System.out.println(dataVector);
        ...
        buildConfigTable.getColumnModel().getColumn(5).setCellRenderer((table, value, isSelected, hasFocus, row, column) -> new JButton("添加"));
        buildConfigTable.getColumnModel().getColumn(6).setPreferredWidth(30);
        buildConfigTable.getColumnModel().getColumn(5).setPreferredWidth(30);
        buildConfigTable.getColumnModel().getColumn(3).setPreferredWidth(40);
        ...
        buildConfigTable.getColumnModel().getColumn(0).setCellRenderer(new MyFileChooserRenderer());
        buildConfigTable.getColumnModel().getColumn(0).setPreferredWidth(150);
    }
