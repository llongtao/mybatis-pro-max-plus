...
public class ModelConfigTable {
    ...
    public ModelConfigTable() {
        ...
        modelConfigTable.getColumnModel().getColumn(8).setPreferredWidth(30);
        modelConfigTable.getColumnModel().getColumn(7).setPreferredWidth(30);
        modelConfigTable.getColumnModel().getColumn(5).setPreferredWidth(30);
