...
import com.llt.mybatis.pro.max.plus.view.BaseConfigForm;
import com.llt.mybatis.pro.max.plus.view.BuildConfigTable;
import com.llt.mybatis.pro.max.plus.view.ConfigDataHolder;
import com.llt.mybatis.pro.max.plus.view.ModelConfigTable;
...
public class MainSwing {
    ...
    private static Logger log = LoggerFactory.getLogger(MainSwing.class);
    ...
    public JPanel initCenter(Project project) {
        ...
        right.setPreferredSize(new Dimension(500, 150));
            ...
            try {
                ...
                if (run.isSucceed()) {
                    if (run.getTotal() == 0) {
                        ...
                        Messages.showMessageDialog("已生成"+run.getTotal()+"条记录,请查看指定目录下base文件夹\n(若未生成,右键选择指定文件夹选择Synchronize同步新增文件)\r\n"+stringBuilder, "提示", Messages.getInformationIcon());
                    }
                }else {
